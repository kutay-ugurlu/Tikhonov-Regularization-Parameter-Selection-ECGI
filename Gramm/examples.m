...
% dataset)
data = load('TEMPORAL_GRAMM_RESULTS_NEW.mat');
data = data.TEMPORAL_GRAMM_RESULTS;
%%% 
...
g=gramm('x',data.TestDataNumeric,'y',data.temporalCC,'color',data.TrainingDataNumeric)%,'subset',cars.Cylinders~=3 & cars.Cylinders~=5);
%%% 
...
g.set_names('column','Origin','x','Datasets','y','TemporalCC','color','Training Data');
%%%
% Set figure title
g.set_title('Temporal CC of simulations run on different datasets with training data');
%%%
